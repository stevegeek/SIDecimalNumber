...
@implementation SIDecimalNumberHandlerTest : OJTestCase

- (void)testinitWithRoundingMode
{
    var h1 = [SIDecimalNumberHandler alloc];
...
{
    var h1 = [SIDecimalNumberHandler decimalNumberHandlerWithRoundingMode:CPRoundPlain scale:0 raiseOnExactness:NO raiseOnOverflow:NO raiseOnUnderflow:NO raiseOnDivideByZero:NO];
...
{
    [self assert:_cappdefaultDcmHandler equals:[SIDecimalNumberHandler defaultDecimalNumberHandler] message:"T1 defaultDecimalNumberHandler returned different handler than the current default"];
}

- (void)testroundingMode
{
    var h1 = [SIDecimalNumberHandler decimalNumberHandlerWithRoundingMode:CPRoundDown scale:0 raiseOnExactness:NO raiseOnOverflow:NO raiseOnUnderflow:NO raiseOnDivideByZero:NO];
...
- (void)testscale
{
    var h1 = [SIDecimalNumberHandler decimalNumberHandlerWithRoundingMode:CPRoundDown scale:-6 raiseOnExactness:NO raiseOnOverflow:NO raiseOnUnderflow:NO raiseOnDivideByZero:NO];
...
- (void)testexceptionDuringOperation
{
    ...
    var a = [SIDecimalNumber decimalNumberWithString:@"100"];
    var b = [SIDecimalNumber decimalNumberWithString:@"100"];
    ...
    // now throw
    h1 = [SIDecimalNumberHandler decimalNumberHandlerWithRoundingMode:CPRoundDown scale:0 raiseOnExactness:YES raiseOnOverflow:YES raiseOnUnderflow:YES raiseOnDivideByZero:YES];
    try {
        [h1 exceptionDuringOperation:nil error:CPCalculationLossOfPrecision leftOperand:a rightOperand:b];
